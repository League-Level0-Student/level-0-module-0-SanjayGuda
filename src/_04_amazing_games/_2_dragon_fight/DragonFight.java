...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		// 2. Create some variables to hold the attack strengths. These will be given different values later. 
			...
			// to 0 for now.
			int dragonAttack = ran.nextInt(10);
		...
		while (true) {
			...
			// ASSESS THE DAMAGE
				...
				// 		dragon have left.
						JOptionPane.showMessageDialog(null, " Player's health is " + playerHealth + " and the Dragon's Health is " + dragonHealth);
	...
	static void dragonLost() {
		...
		// 12. Tell the user that the dragon has been defeated and they get a ton of gold!
			JOptionPane.showMessageDialog(null, "You have defeated the dragon and now have a ton of gold!");
		System.exit(0);   //This code ends the program
	}
